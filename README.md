...
pixi add cuda-cupti cuda-cupti-dev cuda-cupti-doc cuda-cupti-static
# for installing globally
pixi global install cuda-cupti cuda-cupti-dev cuda-cupti-doc cuda-cupti-static
```
...
It is possible to list all of the versions of `cuda-cupti` available on your platform:
...
```
pixi search cuda-cupti --channel conda-forge
```
